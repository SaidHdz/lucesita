  ...
  return (
    <section className="relative min-h-[100dvh] w-full bg-[#050505] text-white flex flex-col items-center justify-start overflow-y-auto overflow-x-hidden pt-20 pb-36 px-4 md:px-12 selection:bg-purple-500/30 selection:text-white">
      ...
      <motion.button 
        ...
        onClick={onBack}
        className="fixed top-6 left-6 z-50 p-3.5 rounded-full bg-white/[0.08] backdrop-blur-2xl border border-white/15 text-white hover:bg-white/20 hover:border-white/40 transition-all duration-300 shadow-2xl group flex items-center gap-2"
      ...
      <motion.div 
        ...
        className="text-center z-10 max-w-3xl mb-10 flex flex-col items-center"
      >
        ...
        <h1 className="text-4xl sm:text-6xl md:text-7xl font-sans font-black tracking-tighter text-white mb-4 leading-tight">
        ...
        <p className="text-white/60 font-sans text-base md:text-lg max-w-xl font-light leading-relaxed">
          Algunas de las cartas que te escribi, espero que te gusten, disculpa la tardanza
        </p>
      </motion.div>
